...
class CCU(Device):
    def __init__(self, start=0x01C20000):
        ...
        PLL_CPUX_CTRL_REG.register(1, 1, Datapoint("", default=2))
        PLL_CPUX_CTRL_REG.register(10, 1, Datapoint("", default=4))
        ...
        PLL_MIPI_CTRL_REG.register(27, 1, Datapoint("SINT_FRAC", default=0))
        PLL_MIPI_CTRL_REG.register(26, 1, Datapoint("SDIV2", default=0))
        PLL_MIPI_CTRL_REG.register(25, 1, Datapoint("S6P25_7P5", default=0))
        PLL_MIPI_CTRL_REG.register(23, 1, Datapoint("LDO1_EN", default=0))
        PLL_MIPI_CTRL_REG.register(22, 1, Datapoint("LDO2_EN", default=0))
        PLL_MIPI_CTRL_REG.register(21, 1, Datapoint("PLL_SRC", default=0))
        ...
        CPU_AXI_CFG_REG.register(1, 1, Datapoint("", default=2))
        CPU_AXI_CFG_REG.register(0, 2, Datapoint("AXI_CLK_DIV_RATIO", default=0))
        CPU_AXI_CFG_REG.register(1, 1, Datapoint("", default=2))
        CPU_AXI_CFG_REG.register(10, 1, Datapoint("", default=3))
        ...
        AHB1_APB1_CFG_REG.register(1, 1, Datapoint("", default=2))
        AHB1_APB1_CFG_REG.register(6, 2, Datapoint("AHB1_PRE_DIV", default=0))
        AHB1_APB1_CFG_REG.register(1, 1, Datapoint("", default=2))
        AHB1_APB1_CFG_REG.register(10, 1, Datapoint("", default=3))
        AHB1_APB1_CFG_REG.register(4, 2, Datapoint("AHB1_CLK_DIV_RATIO", default=1))
        AHB1_APB1_CFG_REG.register(1, 1, Datapoint("", default=2))
        AHB1_APB1_CFG_REG.register(10, 1, Datapoint("", default=4))
        APB2_CFG_REG = Reg32("APB2_CFG_REG", 0x0058)
        self.block(APB2_CFG_REG)
        APB2_CFG_REG.register(24, 2, Datapoint("APB2_CLK_SRC_SEL", default=1))
        APB2_CFG_REG.register(16, 2, Datapoint("CLK_RAT_N", default=0))
        APB2_CFG_REG.register(1, 1, Datapoint("", default=2))
        APB2_CFG_REG.register(10, 1, Datapoint("", default=4))
        APB2_CFG_REG.register(0, 5, Datapoint("CLK_RAT_M", default=0))
        ...
        NAND_CLK_REG.register(1, 1, Datapoint("", default=2))
        NAND_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        SDMMC0_CLK_REG.register(1, 1, Datapoint("", default=2))
        SDMMC0_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        SDMMC1_CLK_REG.register(1, 1, Datapoint("", default=2))
        SDMMC1_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        SDMMC2_CLK_REG.register(1, 1, Datapoint("", default=2))
        SDMMC2_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        SS_CLK_REG.register(1, 1, Datapoint("", default=2))
        SS_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        SPI0_CLK_REG.register(1, 1, Datapoint("", default=2))
        SPI0_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        SPI1_CLK_REG.register(10, 1, Datapoint("", default=4))
        ...
        USBPHY_CFG_REG.register(11, 1, Datapoint("SCLK_GATING_12M", default=0))
        USBPHY_CFG_REG.register(10, 1, Datapoint("SCLK_GATING_HSIC", default=0))
        ...
        USBPHY_CFG_REG.register(2, 1, Datapoint("USBHSIC_RST", default=0))
        ...
        PLL_STABLE_TIME_REG0.register(0, 16, Datapoint("PLL_LOCK_TIME", default=255))
        PLL_STABLE_TIME_REG1 = Reg32("PLL_STABLE_TIME_REG1", 0x0204)
        self.block(PLL_STABLE_TIME_REG1)
        PLL_STABLE_TIME_REG1.register(0, 16, Datapoint("PLL_CPU_LOCK_TIME", default=255))
        PLL_CPUX_BIAS_REG = Reg32("PLL_CPUX_BIAS_REG", 0x0220)
        self.block(PLL_CPUX_BIAS_REG)
        PLL_CPUX_BIAS_REG.register(31, 1, Datapoint("VCO_RST", default=0))
        PLL_CPUX_BIAS_REG.register(28, 1, Datapoint("EXG_MODE", default=0))
        PLL_CPUX_BIAS_REG.register(24, 4, Datapoint("PLL_VCO_BIAS_CTRL", default=8))
        PLL_CPUX_BIAS_REG.register(16, 5, Datapoint("PLL_BIAS_CUR_CTRL", default=16))
        PLL_CPUX_BIAS_REG.register(8, 3, Datapoint("PLL_LOCK_CTRL", default=2))
        PLL_CPUX_BIAS_REG.register(0, 4, Datapoint("PLL_DAMP_FACT_CTRL", default=0))
        ...
        BUS_SOFT_RST_REG1.register(5, 3, Datapoint("", default=None))
